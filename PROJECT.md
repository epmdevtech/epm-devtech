...
| ScrollToTop       | ✅ Refatorado    | Ícone ChevronUp (20px), design flat sem glow/sombra, borda de 1px sólida na cor da marca (border-emerald-500), cores de tema consistentes com o rodapé (WCAG AA/AAA), exibição condicionada a >450px com fade suave e elevação dinâmica no rodapé |
